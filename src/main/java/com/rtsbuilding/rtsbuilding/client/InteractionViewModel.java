...
public class InteractionViewModel {
    ...
    public String quickBuildShape = "cube"; // block, plane, cube, sphere, cylinder, pyramid, line
    public String quickBuildFill = "fill"; // fill, hollow, wireframe
    public int quickBuildSizeX = 3;
    public int quickBuildSizeY = 3;
    public int quickBuildSizeZ = 3;
    public int quickBuildRotation = 0; // 0-3 (90° 为单位)
    ...
    public static final int MAX_RECENT_BLOCKS = 16;
